...
1. **Header Toggle**: The entire header area (arrow, icon, and name) must act as a single-click toggle hitbox to expand/collapse the node. No double-click triggers or sub-component overrides.
